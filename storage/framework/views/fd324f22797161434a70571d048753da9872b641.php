			...
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					...
					<div class="courses pt-20">
						...
						<a href="#" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown"><?php echo e($subject->name); ?></a>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<ul class="courses-list">
									...
									<li>
										<a class="wow fadeInLeft" href="/courses" data-wow-duration="1s" data-wow-delay="1.1s">
											<i class="fa fa-book"></i> Business
										</a>
									</li>
									<li>
										<a class="wow fadeInLeft" href="/courses" data-wow-duration="1s" data-wow-delay="1.3s">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<ul class="courses-list">
									<li>
										<a class="wow fadeInRight" href="/courses" data-wow-duration="1s" data-wow-delay="1.3s">
...
</html><?php /**PATH F:\NHC_D\xamp\htdocs\Tuitionee\resources\views/index.blade.php ENDPATH**/ ?>